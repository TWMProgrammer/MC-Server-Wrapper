...
import { ModUpdate } from '../types'

interface InstalledModBulkActionsProps {
...
export function InstalledModBulkActions({
  selectedCount,
  hasUpdates,
  onBulkToggle,
  onBulkUpdate,
      ...
      <div className="bg-primary/10 border border-primary/20 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <ConfirmDropdown
            ...
            message={`Are you sure you want to uninstall ${selectedCount} mods?`}
