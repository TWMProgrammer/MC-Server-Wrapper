...
export function MarketplaceModal({ instanceId, onClose, onInstallSuccess }: MarketplaceModalProps) {
    ...
    >
      <div className="w-full h-full flex items-center justify-center p-4 md:p-8">
        ...
        <motion.div
          ...
          className="relative w-[80%] h-[80%] bg-surface border border-white/10 rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col"
        >
          {/* Header */}
          ...
          <div className="flex-1 overflow-hidden p-8 min-h-0 flex flex-col">
            <Marketplace instanceId={instanceId} onInstallSuccess={onInstallSuccess} />
          </div>
        </motion.div>
      </div>
    </div>,
