...
import { Project, PluginProvider, SortOrder, SearchOptions } from '../types'
...
export function Marketplace({ instanceId, onInstallSuccess }: MarketplaceProps) {
  ...
  const handleSearch = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      // Always filter for plugins on Modrinth to avoid showing mods (Fabric/Forge)
  ...
  useEffect(() => {
    handleSearch()
  }, [provider, activeCategory, sortOrder, page])
