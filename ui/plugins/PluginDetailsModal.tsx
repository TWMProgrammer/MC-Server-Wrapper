            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-3 mb-1">
                ...
                <span className={`text-xs px-2 py-0.5 rounded-full font-bold uppercase tracking-wider ${
                  project.provider === 'Modrinth' ? 'bg-green-500/10 text-green-500' : 'bg-orange-500/10 text-orange-500'
                }`}>
                  {project.provider}
                </span>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 leading-relaxed">
                      This will download the latest compatible version of <b>{project.title}</b> directly into your server's plugins folder. Some plugins may require a server restart to take effect.
                    </p>
                  </div>
                </div>
              </section>
            ...
            <div className="space-y-6">
              <div className="bg-white/5 border border-white/5 rounded-2xl p-6 space-y-4">
                ...
                <div className="pt-4 border-t border-white/5">
                  <a
                    href={project.provider === 'Modrinth' 
              ...
              <button
                onClick={onInstall}
                className={`w-full py-4 rounded-2xl font-bold shadow-lg transition-all flex items-center justify-center gap-3 ${
                  isSelected 
