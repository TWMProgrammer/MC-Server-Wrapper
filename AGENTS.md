...
- **Frontend Verification**: After UI changes, you **MUST** use the **MCP Puppeteer server** to navigate to `http://localhost:3000` and take screenshots or inspect elements to verify the changes visually and functionally.
